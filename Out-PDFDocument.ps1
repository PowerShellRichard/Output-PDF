...
# Updated by Richard Li
# Updated on 20 May 2016
# Updated: Added switch "Landscape" to allow specifying landscape page orientation
...
Function Out-PDFDocument
{
  ...
  Begin
  {
    ...
    Function Add-Line
    {
      ...
      ForEach ($line in ($text -split '\n'))
      {
        ...
        if ($linecount -gt ($page.Height.Value-$fontsize))
        {
          ...
          if ($Landscape -eq $true) { $script:page.Orientation = "Landscape"  } # page orientation
    ...
    try {
      ...
      $null = $psBoundParameters.Remove('Landscape')
